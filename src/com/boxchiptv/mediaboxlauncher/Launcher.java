...
public class Launcher extends Activity{
  ...
  /*  private final static String  MUSIC_KEY = "Music";
    ...
    private final static String  PICTURE_KEY = "Picure";
    */
  ...
  /*  public  static String[] list_Music;
    public  static String[] list_Video;
    ...
    */
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     /*   if (DesUtils.isboxchiptvChip() == false){
            finish();
        }
*/
				loadIntentParam();
...
/*	
	public  boolean isSdcardExists(){
		...
		for(StorageVolume volume:volumes){	
			if(volume.getPath().equals(SD_PATH) && mStorageManager.getVolumeState(volume.getPath()).equals("mounted")){
				return true;
			}
		}		
		return false;
        ...
        File mFile = new File(path);
            ...
            while( (str=br.readLine()) != null ){
                ...
                else if (str.startsWith(SETTING_KEY))
                {
             	 ...
             	 /* else if (str.startsWith(MUSIC_KEY))
                {
                    str = str.replaceAll(MUSIC_KEY, "");
			      			  list_Music = str.split(";");
                }
                
                else if (str.startsWith(VIDEO_KEY))
                {
                    str = str.replaceAll(VIDEO_KEY, "");
			      			  list_Video = str.split(";");
                }
                
                 else if (str.startsWith(PICTURE_KEY))
                {
                    str = str.replaceAll(PICTURE_KEY, "");
			      			  list_Picure = str.split(";");
                }
                 */ 
        ...
        else
        {
          	 ...
          	 sendWeatherBroadcast();
                ...
                bHasGetWether = true;
						  ...
						  || action.equals(net_change_action))
						  {
					 			sendWeatherBroadcast();		
					 			displayStatus();
								updateStatus();		
